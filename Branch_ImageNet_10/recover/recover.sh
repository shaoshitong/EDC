CUDA_VISIBLE_DEVICES=0,1,2,3 python recover.py \
    ...
    --verifier --store-best-images --gpu-id 0,1,2,3 --initial-img-dir /home/sst/product/RDED/exp/imagenet-10_resnet18_f2_mipc300_ipc10_cr5/syn_data/